...
Storing the Bounding boxes of the heads present
...
Storing final centers

"""
    
            for key in box_list.keys():
                temp_key = box_list[key]
                final_center_list['c_' + str(key)].append([temp_key[0]+   temp_key[2]/2  , temp_key[1]+ temp_key[3]/2]) 
...
#             p4_box = boxes[3]
            ...
            for box in range(0,len(boxes)):
                new_key = new_temp_box['p'+ str(box)+'_box']
                temp_centers['temp_c'+ str(box)] = [new_key[0] + new_key[2]/2 , new_key[1] + new_key[3]/2]
...
#             temp_c4 = [p4_box[0] + p4_box[2]/2 , p4_box[1] + p4_box[3]/2 ]   
            ...
            for key in temp_centers.keys():
                ...
                coord_mat.append([t_key[0], t_key[1]])
            
            
            for key in temp_centers.keys():
                center_mat.append(temp_center[key])
